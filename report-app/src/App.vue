...
<template>
  ...
  <div class="grid">
    ...
    <HumidityChart :chart-b64="data.chart_b64" :readings="data.humidity_readings" />
    <EventTimeline title="Node Events" :events="data.node_events" />
    <EventTimeline title="Master Events" :events="data.master_events" />
    <RawUartOutput title="Node UART Output" :raw-uart="data.node_raw_uart" />
    <RawUartOutput title="Master UART Output" :raw-uart="data.master_raw_uart" />
  </div>
</template>
